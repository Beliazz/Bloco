...
private:
	...
	bool SetScriptEventManager(LuaObject em);


	shared_ptr< ScriptEventManager > m_pScriptEventManager;
...
class ScriptEventManager : public IEventListener
{
public:

	explicit ScriptEventManager(LuaObject luaObj);
