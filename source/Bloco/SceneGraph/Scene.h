...
public:
	...
	virtual Vec GetPosition()	{ return m_Position; }
...
public:
	...
	string GetName()  {return "SceneNode keyboard handler";}

	void SetObject(shared_ptr<ISceneNode> newObject);
	void OnUpdate( const int deltaMilliseconds );
	void OnUpdateSimpleInput( const int deltaMilliseconds );
...
public:
	...
	virtual Vec GetPosition()	{ return SceneNode::GetPosition(); }
